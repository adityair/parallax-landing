...
function initLoader() {
    ...
    const image = select('.splash-image img');
    const mask = select('.splash-image--mask');
    // const line1 = select('.loader__title--mask:nth-child(1) span');
    // const line2 = select('.loader__title--mask:nth-child(2) span');
    // const line3 = select('.loader__title--mask:nth-child(3) span');
    ...
    tlLoaderIn
        ...
        // .from([line1], {yPercent: 100, stagger: 0.1}, 'revealImage-=0.5');
